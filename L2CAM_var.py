...
if __name__ == '__main__':
    sigma_int = [10, 20, 33, 60, 83, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
    result = open("5way1shot_variation_L2CAM.txt", "a+")
    for i in range(0, 15, 1):
        ...
        for cycle in range(0,10,1):
            ...
            for _ in range(40):  # 200*50=10000 batches task
                ...
                variation = sigma * 0.01 * torch.randn(args.n_way, 64).cuda()
