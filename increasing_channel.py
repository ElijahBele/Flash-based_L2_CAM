# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 16:49:18 2022
...
if __name__ == '__main__':
    ...
    maml = Proto(args, config, load_model=False)#.to(device)
    ...
    for step in range(args.epoch):
        ...
        #         #print(y_spt_one)
        #         # test_acc = maml.finetunning(x_spt_one, y_spt_one, x_qry_one, y_qry_one)
        #         test_acc = maml.test_quantize(x_spt_one, y_spt_one, x_qry_one, y_qry_one,precision=3)
        #         # test_acc = maml.test(x_spt_one, y_spt_one, x_qry_one, y_qry_one)
        #         accs.append( test_acc )
